...
by_xpath('//*[@id="signin_form_container"]/form/div[1]/div[2]/input').send_keys('7sb5c@wimsg.com')  # Email ID 입력
...
time.sleep(3)
by_xpath('//*[@id="wrap"]/article/div/section[2]/article/ul/li[1]/div/button[2]/span/span').click()  # Dave Test.Team 으로 진입
...
time.sleep(1)
by_xpath('//*[@id="jndApp"]/div[7]/div/div/div/form/div[1]/div[4]/div/div/textarea').send_keys('Selenium 에서 자동으로 생성된 토픽 입니다.')  # 토픽 설명 입력(정회원인 경우 div[7] 로 변경)
...
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div/div[2]/div[1]/div/div/dl/dd[1]').click()  # 검색된 토픽 리스트에서 최상단 토픽 클릭
by_xpath('//*[@id="msgs_container"]/div[2]/div/div[3]/button').click()  # 멤버 초대하기 버튼 클릭
time.sleep(1)
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div[1]/div/section[1]/ul/li[1]/div/input').send_keys('김대웅')  # 검색 할 멤버 입력
time.sleep(1)
# 아래는 Dave Test.Team 에서만 사용 가능한 스크립트
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div[1]/div/section[2]/div[1]/div[1]/div/div[3]/div/div[1]').click()  # 첫번째 '김대웅' 선택
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div[1]/div/section[2]/div[1]/div[1]/div/div[3]/div/div[1]').click()  # 두번째 '김대웅 자동화 Dave' 선택
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div[1]/div/section[2]/div[1]/div[1]/div/div[3]/div/div[1]').click()  # 세번째 '김대웅 테스트' 선택
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div[1]/div/section[2]/div[1]/div[1]/div/div[3]/div/div[1]').click()  # 네번째 '김대웅_5개 토픽' 선택(준회원 5개 토픽 초과 멤버)
time.sleep(0.5)
by_xpath('//*[@id="jndApp"]/div[7]/div/div/div/div[2]/div/button').click()  # 준회원은 최대 5개의 토픽에만 참여가 가능합니다. 알럿 팝업 확인 클릭
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div[2]/button[2]').click()  # 초대하기 클릭
time.sleep(0.5)
...
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div/button[2]').click()  # 삭제 확인 다이얼로그 확인 버튼 클릭
time.sleep(5)
...
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div[2]/div/div[1]/div/div/input').send_keys('자동화 테스트 투표')
by_xpath('//*[@id="poll_message_input"]').send_keys('자동화 테스트 툴을 투표해주세요 by.Selenium.')
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div[2]/div/div[3]/div/div/ul/li[1]/p/input').send_keys('Selenium' + Keys.ENTER)  # 보기1 입력하고 보기 하나더 추가
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div[2]/div/div[3]/div/div/ul/li[2]/p/input').send_keys('Selenide' + Keys.ENTER)  # 보기2 입력하고 보기 하나더 추가
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div[2]/div/div[3]/div/div/ul/li[3]/p/input').send_keys('Appium' + Keys.ENTER)  # 보기3 입력하고 보기 하나더 추가
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div[2]/div/div[3]/div/div/ul/li[4]/p/input').send_keys('Automation Anywhere')  # 보기4 입력
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div[3]/button[2]').click()  # 투표 만들기 클릭
time.sleep(1)
...
time.sleep(0.5)
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div/button[1]').click()  # 투표 마감 취소 하기
by_xpath('//*[@id="jndApp"]/div[1]/div[2]/div[2]/div[3]/div/div[1]/div[2]/div/div[1]/div/ul/li[1]').click()  # 투표 상세 [...] 더보기 버튼 클릭
by_xpath('//*[@id="jndApp"]/div[1]/div[2]/div[2]/div[3]/div/div[1]/div[2]/div/div[1]/div/ul/li[1]/div/ul/li[3]').click()  # 투표 마감하기 메뉴 클릭
time.sleep(0.5)
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div/button[2]').click()  # 투표 마감 하기
time.sleep(5)
...
time.sleep(0.5)
by_xpath('//*[@id="jndApp"]/div[6]/div/div/div/div[2]/div/button[2]').click()  # 토픽 삭제 확인 다이얼로그 확인 클릭
time.sleep(0.5)
m_input.send_keys('테스트 토픽이 삭제 되었습니다.' + Keys.ENTER)
